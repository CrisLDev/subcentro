...
import Loading from '../Loading';
  ...
  validations:{
    ...
    computed: {
      userNameNErrors (){
          const errors = []
            ...
            !this.$v.userNameN.maxLength && errors.push('El nombre no debe tener mas de 10 caracteres')
      ...
      fullNameNErrors (){
          const errors = []
            ...
            !this.$v.fullNameN.maxLength && errors.push('El nombre no debe tener mas de 50 caracteres')
            !this.$v.fullNameN.required && errors.push('El nombre completo es requerido.')
            return errors
      },
      telephoneNumberNErrors (){
          const errors = []
            if(!this.$v.telephoneNumberN.$dirty) return errors
            !this.$v.telephoneNumberN.maxLength && errors.push('El numero de telefono no debe tener mas de 10 numeros')
            !this.$v.telephoneNumberN.required && errors.push('El número de telefono es requerido.')
            return errors
      },
      emailNErrors (){
          const errors = []
            if(!this.$v.emailN.$dirty) return errors
            !this.$v.emailN.maxLength && errors.push('El email no debe tener mas de 50 caracteres')
      ...
      passwordNErrors (){
          ...
          if(!this.$v.passwordN.$dirty) return errors
            !this.$v.passwordN.maxLength && errors.push('La contrasena no debe tener mas de 20 caracteres')
      ...
      password2NErrors (){
          const errors = []
            ...
            !this.$v.password2N.maxLength && errors.push('La contrasena de confirmacion no debe tener mas de 20 caracteres')
      ...
      adressNErrors (){
          const errors = []
            ...
            !this.$v.adressN.maxLength && errors.push('La direccion no debe tener mas de 50 caracteres')
      ...
      dniNErrors (){
          const errors = []
            ...
            !this.$v.dniN.maxLength && errors.push('El numero de cédula no debe tener mas de 10 numeros')
            !this.$v.dniN.required && errors.push('El número de cédula es requerido.')
            return errors
      },
      dateNErrors (){
          const errors = []
            if(!this.$v.dateN.$dirty) return errors
            !this.$v.dateN.required && errors.push('La fecha de nacimiento es requerida.')
            return errors
      },
    ...
    methods: {
      ...
      async submit () {
        await this.$v.$touch();
          if(this.userNameNErrors.length >= 1 || this.fullNameNErrors.length >= 1 || this.emailNErrors.length >= 1 || this.telephoneNumberNErrors.length >= 1 || this.passwordNErrors.length >= 1 || this.password2NErrors.length >= 1 || this.adressNErrors.length >= 1 || this.dniNErrors.length >= 1 || this.dateNErrors.length >= 1){
                const snackbarData = {
                    timeout: 2000,
